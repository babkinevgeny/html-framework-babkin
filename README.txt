Сетка фреймворка состоит из строки и колонок, которые имеются по принципу БЭМ. Главный центровщик имеет класс "wrapper".
Строка имеет класс "parent". Колонки именуются child__(размер колонки xl, lg, md, sm, xs)--(кол-во места которое занимает блок от 1 до 12). Например:
  <div class="">
    <div class="child__xl--6 child__xl--9"></div>
    <div class="child__xl--6 child_xl--3"></div>
  </div>
